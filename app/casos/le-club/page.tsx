...
import {
  ...
  Users, Droplets, Wrench, Shield, PiggyBank, Landmark, FileCheck, ArrowLeft
} from 'lucide-react';
import {
...
export default function CasoLeClub() {
  ...
  return (
    <main className="min-h-screen bg-gradient-to-br from-[#070c14] via-[#0a121e] to-[#08111c] p-4">
      <div className="max-w-[1600px] mx-auto">
        ...
        <Link
          href="/"
          className="inline-flex items-center gap-1.5 text-[#9eb0c4] hover:text-white text-xs mb-4 transition-colors"
        >
          <ArrowLeft className="w-3.5 h-3.5" />
          Volver a servicios NeoConsulting
        </Link>
